...
const moduleLoaders: Record<WidgetKind, () => Promise<WidgetModule>> = {
  ...
  tdayTasks: () => import("./tday-tasks") as Promise<WidgetModule>,
  ...
  uptimeStatus: () => import("./uptime-status") as Promise<WidgetModule>,
...
const componentLoaders: Record<WidgetKind, () => Promise<WidgetComponentModule>> = {
  ...
  tdayTasks: () => import("./tday-tasks/component") as Promise<WidgetComponentModule>,
  ...
  uptimeStatus: () => import("./uptime-status/component") as Promise<WidgetComponentModule>,
